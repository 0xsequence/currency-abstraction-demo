    ...
    <>
      ...
      <Box marginTop="5" marginBottom="4" style={{ maxWidth: 600 }}>
        <Text color="text100">
          ...
          <Text color="text100" as="a" href={'https://sequence.build'} target="_blank" rel="noreferrer ">
            Sequence Builder
          </Text>
          , a tool for developing NFT collections and related sales contracts for minting new tokens. It also shows how you can
